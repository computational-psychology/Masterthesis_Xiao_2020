...
# crop circular patch and combine images
def crop_circular_patch(n_image_size,n_circle_center,n_circle_radius,
						n_file_name,s_file_name,full_file_name):
	# import the background image
...
n_grid = 90
n_image_size = 600
n_weight = 0.2 # transparency alpha
n_circle_color = 160
f_file_name = "contrast_contrast_illusion_background_"+str(n_image_size)+".png"
n_file_name = "contrast_contrast_illusion_high_contrast_background_"+str(n_image_size)+"_alpha_"+str(n_weight)+"_ref_"+str(n_circle_color)+".png"
s_file_name = "contrast_contrast_illusion_low_contrast_background_"+str(n_image_size)+"_alpha_"+str(n_weight)+"_ref_"+str(n_circle_color)+".png"
full_file_name = "contrast_contrast_illusion_"+str(n_image_size)+"_alpha_"+str(n_weight)+"_ref_"+str(n_circle_color)+".png"
